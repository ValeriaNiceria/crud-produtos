<div class="row">
  ...
  <div class="col-sm">
	...
	<div class="jumbotron mt-4">
		...
		<form method="POST" action="exe/exe_login.php" class="form">
			...
			<input type="submit" value="Logar" class="btn btn-primary btn-lg btn-block mt-4"/>

			<a href="" class="btn mt-4">Novo usuário</a>
